package net.dontdrinkandroot.example.angularrestspringsecurity.dao.generico.impl;
...
DaoGenerico<T, ID>, Serializable {
    ...
    @Override
    public T save(T entity) throws UniqueKeyException, Exception {
	try {
...
//	    this.entityManager.flush();
    ...
    @Override
    public T update(T entity) throws UniqueKeyException, Exception {
	try {
