...
@Entity(name = "permissaoUsuario")
@Table(name = "tb_permissoesusuario")
public class PermissaoUsuario implements Serializable {

    private static final long serialVersionUID = 1L;

    @Id
    @SequenceGenerator(name = "permissaoUsuarioSeq", sequenceName = "PERMISSAO_USU_SEQ", allocationSize = 1, initialValue = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "permissaoUsuarioSeq")
    @Column(name = "codigopermusu", nullable = false, updatable = false)
    private Long codigo;
    ...
    @JoinColumn(name = "codigousu", referencedColumnName = "codigousu", nullable = false)
    @ManyToOne(optional = false, fetch = FetchType.LAZY)
